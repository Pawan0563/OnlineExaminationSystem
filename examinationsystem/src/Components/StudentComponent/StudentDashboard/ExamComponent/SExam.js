                ...
                if(data.name.name === category) {
                    return (
                        <div className={examStyles.examBox} key={i}>
                            ...
                            <div><span>Exam ID: {data.id}</span></div>
                            <div><span>Exam Description: {data.desc}</span></div>
                            <div><span>Pass Marks: {data.passMarks}</span></div>
                            <div><span>Total Marks: {data.marks}</span></div>
                            <div>
